...
/// <summary>
    /// Circular buffer.
    ///
    /// Author: https://github.com/joaoportela/CircularBuffer-CSharp/tree/master/CircularBuffer
    /// 
    ...
    public class CircularBuffer<T> : IEnumerable<T>
    {
        ...
        /// </param>
        public CircularBuffer(int capacity) : this(capacity, new T[] { }) { /* skip */ }
        ...
        public T? PopValueFromFront()
        {
            ThrowIfEmpty("Cannot take elements from an empty buffer.");
            T? value = _buffer[_start];
            PopFront();
            return value;
        }
